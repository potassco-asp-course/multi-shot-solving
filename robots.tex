% \subsection{Playing in rounds}
% ------------------------------------------------------------
\begin{frame}[c]{Alex Rudolph's Ricochet Robots\\[-5pt]\footnotesize
    \uncover<4->{Solving \lstinline{goal(13)} from cornered robots}}
  \bigskip\qquad\includegraphics[width=0.45\textwidth]{msolving/snapshots/goal13a.png}
  % \hspace{0.08\textwidth}
  % \includegraphics[width=0.45\textwidth]{mSolving/snapshots/goal13z.png}
  \qquad
...
\begin{frame}{Solving \lstinline{goal(13)} from cornered robots (ctd)}
  \bigskip\quad
  \only<1->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move1.png}}\quad
  \only<2->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move2.png}}\quad
  \only<3->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move3.png}}\quad
  \only<4->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move4.png}}
  \\\bigskip\quad
  \only<5->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move5.png}}\quad
  \only<6->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move6.png}}\quad
  \only<7->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move7.png}}\quad
  \only<8->{\includegraphics[width=0.2\textwidth]{msolving/snapshots/move8.png}}
\end{frame}
% ------------------------------------------------------------
\begin{frame}[fragile]{\texttt{board.lp}}
\bigskip
\lstinputlisting[basicstyle=\ttfamily\tiny]{msolving/board.lp}
\end{frame}
\begin{frame}[fragile]{\texttt{targets.lp}}
\bigskip
\lstinputlisting[basicstyle=\ttfamily\tiny]{msolving/targets.lp}
\end{frame}
\begin{frame}[fragile]{\texttt{ricochet.lp}}
\bigskip
\lstinputlisting[basicstyle=\ttfamily\tiny]{msolving/ricochet.lp}
\end{frame}
% ------------------------------------------------------------
...
\bigskip
\lstinputlisting[basicstyle=\ttfamily\tiny]{msolving/optimization.lp}
\end{frame}
% ------------------------------------------------------------
...
\begin{frame}[c]{Playing in rounds}
  ...
  \includegraphics[height=0.35\textheight]{msolving/snapshots/goal13a.png}
  \qquad
  \includegraphics[height=0.35\textheight]{msolving/snapshots/goal13z.png}
  \par\bigskip
  \makebox[100pt][l]{Round 2: \texttt{goal(4)}} \qquad
  \includegraphics[height=0.35\textheight]{msolving/snapshots/goal4a.png}
  \qquad
  \includegraphics[height=0.35\textheight]{msolving/snapshots/goal4z.png}
\end{frame}
% ------------------------------------------------------------
